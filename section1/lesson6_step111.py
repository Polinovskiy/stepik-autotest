...
try: 
    ...
    input1 = browser.find_element_by_tag_name("div.first_block input.first")
    ...
    input3.send_keys("mokko2070@mail.ru")
    input4 = browser.find_element_by_css_selector("div.second_block input")
    input4.send_keys("+799983983983983")
    input5 = browser.find_element_by_css_selector("div.second_block input.second")
